...
const Home = () => {
  ...
  return (
    <div 
      ref={containerRef}
      className="min-h-screen w-full overflow-x-hidden flex flex-col items-center bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
    >
      {/* Background Elements */}
      ...
      <section className="container relative z-10 min-h-screen flex flex-col justify-center">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent"
          >
          ...
          >
            ...
            <Link 
              href="/login"
              className="inline-flex items-center justify-center bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-8 py-4 rounded-full text-lg font-semibold border-2 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300"
            >
              Já tenho conta
            </Link>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              ...
              >
                Começar Grátis
                      ...
                      <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 text-center text-gray-500 dark:text-gray-400 w-full">
